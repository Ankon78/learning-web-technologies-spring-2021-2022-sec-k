...
<script type = "text/javascript">
      ...
      function validate() {
         ...
         if( document.myForm.ServiceType.value == "" ) {
            alert( "Please provide your serviceType!" );
            document.myForm.ServiceType.focus() ;
            return false;
         }
         ...
         if( document.myForm.Place.value == "" ) {
            alert( "Please provide your place name!" );
            document.myForm.Place.focus() ;
            return false;
         }
         if( document.myForm.OtherInfo.value == "" ) {
            alert( "Please provide your otherInfo!" );
            document.myForm.OtherInfo.focus() ;
            return false;
         }
...
<body>
	...
	<div class="naviation">
	   ...
	   <div class="form">
	<form method="POST" action="../controllers/sProviderCheck.php" enctype="multipart/form-data" name = "myForm" onsubmit = "return(validate());">
		...
		<input type="text"class="phone" name="PhoneNo" placeholder="phone no"><br>
